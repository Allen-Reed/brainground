<script>
  ...
  async function fetchActivity() {
    try {
      const response = await fetch(`http://www.boredapi.com/api/activity?type=${category}`)
...
<div class="h-full flex">
  ...
  <div class="w-2/5 mr-36 my-auto">
    <div class="flex justify-center font-heading-token text-3xl">spin the wheel of activities!</div>
    <div
